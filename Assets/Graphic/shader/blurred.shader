		...
		SubShader{
			...
			Pass {
				...
				fixed4 PixShader(pixel_t input) : SV_Target
				{
					...
					half d = tex2D(_MainTex, input.texcoord0.xy + exp(-Mod(_Time.y, 4.0)) * float2(0.005 * sin(input.spos.x *10.0), 0.005 * sin(input.spos.y *20.0))).a * input.param.x;
